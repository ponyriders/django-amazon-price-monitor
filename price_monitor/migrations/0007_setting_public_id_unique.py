...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EmailNotification', fields ['public_id']
        db.create_unique(u'price_monitor_emailnotification', ['public_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailNotification', fields ['public_id']
        db.delete_unique(u'price_monitor_emailnotification', ['public_id'])
    ...
    models = {
        ...
        'price_monitor.emailnotification': {
            ...
            'public_id': ('django.db.models.fields.CharField', [], {'default': "'4be1b385-fcf8-413b-8966-f4482c489c07'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'})
        },
        'price_monitor.price': {
