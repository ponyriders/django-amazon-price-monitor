...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.public_id'
        db.add_column('price_monitor_subscription', 'public_id',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, unique=True, default=None),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Subscription.public_id'
        db.delete_column('price_monitor_subscription', 'public_id')
    ...
    models = {
        ...
        'price_monitor.product': {
            ...
            'pages': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True', 'default': '0'}),
        ...
        'price_monitor.subscription': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['price_monitor.Product']"}),
            'public_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'unique': 'True', 'default': "'36c6dd5f-0b7d-4264-86ff-bcde60622d97'"})
        }
    }
