...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for email_notification in orm.EmailNotification.objects.all():
            email_notification.public_id = str(uuid.uuid4())
    ...
    models = {
        ...
        'price_monitor.emailnotification': {
            ...
            'public_id': ('django.db.models.fields.CharField', [], {'default': "'4f99bf23-f004-4cad-8d09-8cd1609c2dc7'", 'max_length': '36', 'db_index': 'True'})
        },
        'price_monitor.price': {
        ...
        'price_monitor.subscription': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['price_monitor.Product']"}),
            'public_id': ('django.db.models.fields.CharField', [], {'default': "'4f99bf23-f004-4cad-8d09-8cd1609c2dc7'", 'max_length': '36', 'db_index': 'True', 'unique': 'True'})
        }
    }
