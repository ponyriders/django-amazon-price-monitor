...
from .views.RetrieveUpdateDestroyAPIView import RetrieveUpdateDestroyAPIView
...
urlpatterns = patterns(
    ...
    url(r'^products/(?P<asin>(:asin|[0-9a-zA-Z_-]+))/$', RetrieveUpdateDestroyAPIView.as_view(), name='api_product_retrieve'),
