...
from .views.ProductRetrieveUpdateDestroyAPIView import ProductRetrieveUpdateDestroyAPIView
...
urlpatterns = patterns(
    ...
    url(r'^products/(?P<asin>(:asin|[0-9a-zA-Z_-]+))/$', ProductRetrieveUpdateDestroyAPIView.as_view(), name='api_product_retrieve'),
